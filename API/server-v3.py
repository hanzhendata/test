...
def WarningMessage_CurrentDay_Data(KtypeList,current_datetime):
    ...
    for windcode in Windcode_Dict:
        ...
        if not CheckWindData(wsi,Message='WSI Error') :
            continue
        ...
        for windcode in  Windcode_Dict  :
            ...
            for index in range( len(Windcode_Dict[windcode]['tech'+ ktypestr]) ) :
                ...
                if wtc.ErrorCode ==0 :
                    if wtc.Data[0][0] > 10 :
                        break
                if ( Windcode_Dict[windcode]['is_bc'] and Windcode_Dict[windcode]['tech'+ktypestr]['fast_j'][-index-1] < 5 ) or ( ktype==6 and Windcode_Dict[windcode]['type']!=2 and Windcode_Dict[windcode]['tech'+ktypestr]['slow_j'][-index-1] < 5 ):
                        print windcode,ktype,Windcode_Dict[windcode][ktypestr][-index-1]['date']
                        if Windcode_Dict[windcode]['is_bc']:
                            Windcode_Dict[windcode].update({'type':2}) 
